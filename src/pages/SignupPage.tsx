...
export default function SignupPage() {
  const { signUp, signInWithGoogle, signInWithGithub, signInWithMicrosoft, isLoading } = useAuth();
  ...
  const handleSSOSignup = async (provider: 'google' | 'github' | 'microsoft') => {
    try {
      if (provider === 'google') {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-muted">Get started with Autopilot Studio today</p>
        </div>
        ...
        <Card className="bg-card">
          <CardHeader>
            ...
            <CardDescription>
              Create your account to start automating your workflow
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                />
                {errors.full_name && (
                  <p className="text-xs text-accent-red">{errors.full_name.message}</p>
                )}
              </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                >
                  ...
                  and{" "}
                  <Link to="/privacy" className="text-accent-green hover:underline">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              {errors.acceptTerms && (
                <p className="text-xs text-accent-red">{errors.acceptTerms.message}</p>
              )}
